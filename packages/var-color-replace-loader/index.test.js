...
test('replace color ', () => {
  expect(loader.call(loader, demoSource)).toEqual(
    `background: var(--color-orange-10);color: var(--color-moss-5);border-color: var(--color-moss-5);color: #adc;`,
  );
  expect(loader.call(loader, demoSource2)).toEqual(
...
test('toLocaleLowerCase and toLocaleUpperCase color ', () => {
  expect(loader.call(loader, toLocaleLowerCaseDemoSource)).toEqual(
    `background: var(--color-orange-10);color: var(--color-moss-5);border-color: var(--color-moss-5);color: #ABC;`,
  );
