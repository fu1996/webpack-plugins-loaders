...
test('toLocaleLowerCase and toLocaleUpperCase color ', () => {
    expect(loader.call(loader, toLocaleLowerCaseDemoSource)).toEqual(`background: #000;color: #bbb;border-color: #ddd;color: #ADC;`)
    expect(loader.call(loader, toLocaleUpperCaseCaseDemoSource)).toEqual(`background: #000;color: #bbb;border-color: #ddd;color: #adc;`)
})